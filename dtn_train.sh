...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_dtn.py /path/to/data \
    ...
    --criterion label_smoothed_cross_entropy_dtn \
    ...
    --multi-bleu-path ./scripts --remove-bpe \
    --reset-optimizer \
    --restore-from-trans \
    --random-select | tee /path/to/ckpt/backup-log.txt