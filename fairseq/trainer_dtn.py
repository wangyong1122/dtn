...
class Trainer(object):
        ...
        for i, sample in enumerate(samples):
            ...
            try:
                ...
                loss, sample_size, logging_output = self.task.train_step(
                    ...
                    ignore_grad, domain=domain, num_updates = self._num_updates
                )
    ...
    def dummy_train_step(self, dummy_batch, domain=None):
        """Dummy training step for warming caching allocator."""
        self.train_step(dummy_batch, dummy_batch=True, domain=domain)
        self.zero_grad()
