...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--domains', default=None, nargs='+', type=str, metavar='DOMAINSPLIT',
                       help='comma separated list of data domains to use for training, valid and test'
                            '[europarl, medical]')

    parser.add_argument('--train-domains', default=None, nargs='+', type=str, metavar='TRAINSPLIT',
                       help='comma separated list of data domains to use for training'
                            '[europarl, medical]')
    parser.add_argument('--valid-domains', default=None, nargs='+', type=str, metavar='VALIDSPLIT',
                       help='comma separated list of data domains to use for valid'
                            '[europarl, medical]')
    parser.add_argument('--test-domains', default=None, nargs='+', type=str, metavar='TESTSPLIT',
                       help='comma separated list of data domains to use for test'
                            '[europarl, medical]')

    parser.add_argument('--valid-select', default=None, nargs='+', type=str, metavar='SELECTSPLIT',
                       help='comma separated list of data domains to use for valid select'
                            '[europarl, medical]')

    parser.add_argument('--num-ref', default=None, nargs='+', action=StoreDictKeyPair, metavar='NUMREFSPLIT',
                       help='comma separated list of number of references for valid and test'
                            '[1, 1]')
