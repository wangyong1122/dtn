...
class TransformerModel(FairseqModel):
    ...
    def get_enc_parameters(self):
        ...
        params = get_params([self.encoder])

        return params

    def get_dec_parameters(self):
        def get_params(modules):
            return [p for module in modules for p in module.parameters() if p.requires_grad]

        params = get_params([self.decoder])
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths, domain=None):
        """
        Args:
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out=None, incremental_state=None, domain=None):
        """
        Args:
