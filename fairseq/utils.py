...
def save_state_dtn(filename, args, model_state_dict, criterion, optimizer, lr_scheduler,
               num_updates, optim_history=None, extra_state=None):
    if optim_history is None:
        optim_history = []
    if extra_state is None:
    ...
    state_dict = {
        ...
        'optimizer_history': optim_history + [
            {
                'criterion_name': criterion.__class__.__name__,
                'optimizer_name_nmt': optimizer['nmt'].__class__.__name__,
                'optimizer_name_adv': optimizer['adv'].__class__.__name__,
                'lr_scheduler_state': lr_scheduler.state_dict(),
                'num_updates': num_updates,
            }
        ],
        'last_optimizer_state': {'nmt': convert_state_dict_type(optimizer['nmt'].state_dict()), \
                                 'adv': convert_state_dict_type(optimizer['adv'].state_dict())},
        'extra_state': extra_state,
    }
    torch_persistent_save(state_dict, filename)
